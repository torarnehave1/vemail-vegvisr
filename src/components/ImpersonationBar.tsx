...
// vemail's typed AuthUser (lib/auth.ts) omits emailVerificationToken, so read
// the raw `user` blob directly — same payload the app stores at login.
// Self-contained on purpose: no change to shared auth types.
...
export default function ImpersonationBar() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 px-4 py-2 bg-zinc-800 border-b border-zinc-700 text-sm">
